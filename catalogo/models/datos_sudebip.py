...
class estatus_bien(models.Model):
    ...
    estatus_bien_codigo = fields.Char(string='Codigo del Estatus del Bien',size=3,required=True, help='Registra el Codigo del Estatus del Bien')
    estatus_bien_nombre = fields.Char(string='Nombre del Estatus del bien',size=100,required=True, help='Registra la Descripcion del Estatus del Bien')

    _sql_constraints = [('estatus_bien_codigo', 'unique(estatus_bien_codigo)', 'El Código debe se único!')]    
    _sql_constraints = [('estatus_bien_nombre', 'unique(estatus_bien_nombre)', 'El Nombre debe se único!')] 
...
class detalle_adquisi(models.Model):
   ...
   detalle_adquisi_codigo   = fields.Char(string='Código del Detalle',size=6,required=True, help='Registra el Codigo del Detalle de la Adquisicion del Bien')
   ...
   fecha_concurso           = fields.Date(string='Fecha del Concurso',size=8, help='Registra el Nombre la Fecha Concurso de adquisicion del bien')
   ...
   fecha_factura            = fields.Date(string='Fecha de la Factura',size=8, help='Registra la Fecha de la Factura del bien')
   ...
   numero_factura           = fields.Char(string='Numero de Factura',size=15, help='Registra el Numero de Factura del bien')
   ...
   codigo_ad                = fields.Text(string='Código de la Forma de Adquisición', size=3, compute= "compute_generar_codigo")
   ...
   fecha_autoriza           = fields.Date(string='Fecha de Autorización',size=8, help='Registra la Fecha de la Autorización')
   ...
   num_autoriza             = fields.Char(string='Número de Autorización',size=30, help='Registra el Número de la Autorización')
   ...
   nombre_benefici_trans    = fields.Char(string='Nombre del Beneficiario de La Transferencia',size=100, help='Registra el Nombre del Beneficiario por Transferencia')
   fecha_registro_trans     = fields.Date(string='Fecha de Registro de La Transferencia',size=8, help='Registra la Fecha del Registro de la Transferencia')
   nombre_registro_trans    = fields.Char(string='Nombre del Registro de La Transferencia',size=200, help='Registra el Nombre del Registro la Transferencia')
   tomo_trans               = fields.Char(string='Tomo del Registro de La Transferencia',size=20, help='Registra el Tomo del Registro de la Transfrencia')
   folio_trans              = fields.Integer(string='Folio del Registro de La Transferencia',size=6, help='Registra el Folio del Registro')
   fecha_contrato_permuta   = fields.Date(string='Fecha del Contrato de Permuta',size=8, help='Registra la Fecha del Contrato de Permuta')
   tomo_permuta             = fields.Char(string='Tomo del Registro de La Permuta',size=20, help='Registra el Tomo del Registro de la Permuta')
   fecha_registro_permuta   = fields.Date(string='Fecha de Registro de La Permuta',size=8, help='Registra la Fecha del Registro de la Transferencia')
   nombre_registro_permuta  = fields.Char(string='Nombre del Registro de La Permuta',size=200, help='Registra el Nombre del Registro de la Permuta')
   nombre_benefici_permuta  = fields.Char(string='Nombre del Beneficiario de La Permuta',size=100, help='Registra el Nombre del Beneficiario de la  Permuta')
   nombre_copermutante      = fields.Char(string='Nombre del Copermutante',size=100, help='Registra el Nombre del Copermutante')
   numero_contrato_permuta  = fields.Char(string='Numero de Contrato de La Permuta',size=10, help='Registra el Numero de Contrato de la Permuta')
   folio_permuta            = fields.Integer(string='Folio del Registro de La Permuta',size=6, help='Registra el Folio del Registro de la Permuta')
   nombre_registro_dacion   = fields.Char(string='Nombre del Registro de La Dación en Pago',size=200, help='Registra el Nombre del Registro la Dación en Pago')
   folio_dacion             = fields.Integer(string='Folio del Registro de La Dación en Pago',size=6, help='Registra el Folio del Registro de la Dación en Pago')
   fecha_registro_dacion    = fields.Date(string='Fecha de Registro de La Dación en Pago',size=8, help='Registra la Fecha del Registro de la Dación en Pago')
   tomo_dacion              = fields.Char(string='Tomo del Registro de La Dación en Pago',size=20, help='Registra el Tomo del Registro de la Dación en Pago')
   nombre_benefici_dacion   = fields.Char(string='Nombre del Beneficiario de La Dación en Pago',size=100, help='Registra el Nombre del Beneficiario de la Dación en Pago')
   nombre_prop_ant_expro    = fields.Char(string='Nombre del Propietario Anterior',size=100, help='Registra el Nombre del Propietario Anterior')
   nombre_benefici_expro    = fields.Char(string='Nombre del Beneficiario de La Expropiación',size=100, help='Registra el Nombre del Beneficiario de la Expropiación')
   nombre_autoridad_expro   = fields.Char(string='Nombre de la  Autoridad',size=100, help='Registra el Nombre de la Autoridad')
   num_sentencia_expro      = fields.Char(string='Número de la Sentencia',size=30, help='Registra el Número de la Sentencia ó Acto Administrativo')
   fecha_sentencia_expro    = fields.Date(string='Fecha de la Sentencia',size=8, help='Registra la Fecha de la Sentencia ó Acto Administrativo')
   nombre_registro_expro    = fields.Char(string='Nombre del Registro de La Expropiación',size=200, help='Registra el Nombre del Registro la Expropiación')
   fecha_registro_expro     = fields.Date(string='Fecha de Registro de La Expropiación',size=8, help='Registra la Fecha del Registro de la Expropiación')
   folio_expro              = fields.Integer(string='Folio del Registro de La Expropiación',size=6, help='Registra el Folio del Registro de la Expropiación')
   tomo_expro               = fields.Char(string='Tomo del Registro de La Expropiación',size=20, help='Registra el Tomo del Registro de la Expropiación')
   ...
   nombre_benefici_confi    = fields.Char(string='Nombre del Beneficiario de La Confiscación',size=100, help='Registra el Nombre del Beneficiario de la Expropiación')
   nombre_autoridad_confi   = fields.Char(string='Nombre de la  Autoridad',size=100, help='Registra el Nombre de la Autoridad')
   num_sentencia_confi      = fields.Char(string='Número de la Sentencia',size=30, help='Registra el Número de la Sentencia ó Acto Administrativo')
   fecha_sentencia_confi    = fields.Date(string='Fecha de la Sentencia',size=8, help='Registra la Fecha de la Sentencia ó Acto Administrativo')
   nombre_registro_confi    = fields.Char(string='Nombre del Registro de La Confiscación',size=200, help='Registra el Nombre del Registro la Confiscación')
   fecha_registro_confi     = fields.Date(string='Fecha de Registro de La Confiscación',size=8, help='Registra la Fecha del Registro de la Confiscación')
   folio_confi              = fields.Integer(string='Folio del Registro de La Confiscación',size=6, help='Registra el Folio del Registro de la Confiscación')
   tomo_confi               = fields.Char(string='Tomo del Registro de La Confiscación',size=20, help='Registra el Tomo del Registro de la Confiscación')
   nombre_benefici_dona     = fields.Char(string='Nombre del Beneficiario de La Donación',size=100, help='Registra el Nombre del Beneficiario de la Donación')
   numero_contrato_dona     = fields.Char(string='Numero de Contrato',size=10, help='Registra el Numero de Contrato  de La Donación')
   fecha_contrato_dona      = fields.Date(string='Fecha del Contrato',size=8, help='Registra la Fecha del Contrato de La Donación')
   nombre_registro_dona     = fields.Char(string='Nombre del Registro de La  Donación',size=200, help='Registra el Nombre del Registro la  Donación')
   fecha_registro_dona      = fields.Date(string='Fecha de Registro de La  Donación',size=8, help='Registra la Fecha del Registro de la  Donación')
   folio_dona               = fields.Integer(string='Folio del Registro de La  Donación',size=6, help='Registra el Folio del Registro de la  Donación')
   tomo_dona                = fields.Char(string='Tomo del Registro de La  Donación',size=20, help='Registra el Tomo del Registro de la  Donación')
...
class unidad_medida(models.Model):
    ...
    _name = 'unidad_medida'
    #_rec_name = 'proveedores_codigo'
    _rec_name = 'unidad_medida_nombre'
    #_rec_name = 'rif'
    #_rec_name = 'proveedores_tipo'
    #_rec_name = 'proveedores_observacion'
    

    unidad_medida_codigo  = fields.Char(string='Codigo de la Unidad de Medida',size=6,required=True, help='Registra el Codigo del Proveedor del Bien')
    unidad_medida_nombre  = fields.Char(string='Nombre de la Unidad de Medida',size=100,required=True, help='Registra el Nombre de la Unidad de Medida')
    unidad_medida_simbolo = fields.Char(string='Símbolo la Unidad de Medida',size=20,required=True, help='Registra el Símbolo la Unidad de Medida')
   
    unidad_medida_tipo = fields.Char(string='Tipo de la Unidad de Medida',size=200, help='Registra el Tipo de la Unidad de Medida')



    _sql_constraints = [('unidad_medida_codigo', 'unique(unidad_medida_codigo)', 'El Código debe se único!')]  
    _sql_constraints = [(' unidad_medida_nombre', 'unique(unidad_medida_nombre)', 'El Nombre debe se único!')]    
...
class oficinas(models.Model):
     ...
     uniadm_sudebi_codigo  = fields.Many2one('uniadm_sudebi',string='Categorias Administrativas (SUDEBIP)', help='Registra el Codigo de Vinculacion con las Categorias de Unidades Administrativas segun Sudebi ')
     ...
     sedes_id              = fields.Many2one('sedes',string='Sedes' , domain="[('regiones_id','=',regiones_id)]")
...
class tipos_lugares_ubicacion_sudebip(models.Model):
     ...
     #_sql_constraints = [('regiones_codigo ', 'unique(regiones_codigo)', 'El Código debe se único!')] 
     _sql_constraints = [('nombre', 'unique(nombre)', 'El Nombre debe se único!')] 
...
class poliza(models.Model):
     ...
     poliza_tipo          = fields.Selection([('N','Nacional'),('I','Internacional')],string='Tipo de Poliza',size=1,required=True, help='Registra el Tipo de Poliza N nacional I internacional')
...
class paises(models.Model):
     ...
     _sql_constraints = [('paises', 'unique(codigo)', 'El Código debe se único!')]
