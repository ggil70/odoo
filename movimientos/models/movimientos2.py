...
class mov_deta(models.Model):
    ...
    bienes_ids = fields.Many2many('bienes','Numero del Bien', help='Registra el Numero de Bien')
    ...
    def mover(self):
         if self.movimiento_id.cod_mov < '05' or self.movimiento_id.cod_mov <='10':
            recep = self.env['bienes'].search([('id','=',self.bienes_id.id)])
            recep.oficinas_id = self.ofi_receptora
